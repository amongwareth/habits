...
import habits_app.controllers.home_controller as home
...
def init_routing(config):
    ...
    add_controller_routes(config, HomeController, 'home')
    add_controller_routes(config, BooksController, 'books')
    config.scan()
